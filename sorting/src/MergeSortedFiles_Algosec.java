...
public class MergeSortedFiles_Algosec {
    ...
    public static void main(String[] args) {
        List<File> inputFiles = Arrays.asList(new File("C:\\code\\leetcode\\sorting\\src\\resources\\p1.txt"),
                new File("C:\\code\\leetcode\\sorting\\src\\resources\\p2.txt"),
                new File("C:\\code\\leetcode\\sorting\\src\\resources\\p3.txt"));
    ...
    public static void solve(List<File> sortedFiles, File outputFile) {
        // files sorted
        // until file has reached end check all forthe smallest and add it to output
